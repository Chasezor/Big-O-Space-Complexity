...
//You could if you found a way of making it a O(1) or  O(log n)
...
// the methods found within the fuction add a level of completiy that increase the overall space complexity
//also the fuction is dependent on the length of the string 
...
const sub = new SubWithCache()

console.time("not memoized function time");
console.log(SubTwoNums(4,5))
console.log(SubTwoNums(4,5))
console.log(SubTwoNums(4,5))
console.log(SubTwoNums(4,5))
...
console.log(sub.SubTwoNums(3,11))
console.log(sub.SubTwoNums(3,11))
console.log(sub.SubTwoNums(3,11))
console.log(sub.SubTwoNums(3,11))
